...
from .views import HomeView, DealDetailView, AddDealView, UpdateDealView, DeleteDealView, CategoryView, LikeView, CommentView
...
urlpatterns = [
    ...
    path('like/<uuid:pk>/', LikeView, name = 'like_deal'),
